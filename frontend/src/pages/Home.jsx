...
export default function Home({ user, onNavigate }) {
  ...
  return (
    <div className="space-y-8 md:space-y-10">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-600 via-brand-700 to-accent-600 p-6 sm:p-10 md:p-14 text-white shadow-premium">
        ...
        <div className="relative max-w-3xl">
          ...
          <p className="mt-3 text-base sm:text-lg md:text-xl text-white/90 max-w-2xl">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-white text-brand-700 px-5 py-2.5 text-sm font-semibold shadow-lg hover:bg-slate-100 transition"
            >
      ...
      <section className="glass-card p-6 sm:p-8 md:p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {STEPS.map((s) => (
            ...
            >
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-brand-600 to-accent-600 text-white font-bold text-sm shadow-md">
                {s.n}
              </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="rounded-2xl bg-gradient-to-br from-brand-50 to-accent-50 p-6 sm:p-7 ring-1 ring-brand-100">
        ...
        <div className="rounded-2xl bg-slate-900 p-6 sm:p-7 text-slate-100 relative overflow-hidden">
          <div className="absolute -top-10 -right-10 h-40 w-40 rounded-full bg-brand-500/30 blur-3xl pointer-events-none" />
          <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-accent-500/20 blur-3xl pointer-events-none" />
